        ...
        <Show when="signed-in">
          <UserButton>
            <UserButton.MenuItems>
              <UserButton.Link
                label="Home"
                labelIcon={<HugeiconsIcon icon={Home01Icon} size={16} />}
                href="/"
              />
              ...
              {isAgentOrAdmin ? (
                ...
                <UserButton.Link
                  ...
                  labelIcon={<HugeiconsIcon icon={UserAdd01Icon} size={16} />}
                  href="/kyc"
                />
              )}
              ...
              <UserButton.Link
                label="Saved"
                labelIcon={<HugeiconsIcon icon={Bookmark01Icon} size={16} />}
                href="/favourites"
              />
        ...
        <Show when="signed-out">
          <SignInButton mode="modal">
            <Button
              variant="outline"
              size="sm"
              className="flex hover:bg-[#7c3aed] hover:text-white items-center text-white bg-[#7c3aed] gap-2"
            >
              Login
            </Button>
          </SignInButton>
